(function () {
	...
	var tabletop = createCommonjsModule(function (module) {
	(function() {
	  ...
	  */
	  ...
	  if( module.exports) { //don't just use inNodeJS, we may be in Browserify
	...
	var ROW_HEIGHT = 30;
	var ROW_MARGIN = 10;
	var SPREADSHEET_URL = 'https://docs.google.com/spreadsheets/d/121-56BwZe8Cws0A8xE_cSGXc64YD_bBPfQM8o2YVnaM/edit?usp=sharing';
...
miro.onReady(run)
	...
	function syncWithSheet() {
	  return _syncWithSheet.apply(this, arguments);
	}

	function _syncWithSheet() {
	  _syncWithSheet = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
	    var appId, items, viewport, maxWidth;
	    return regenerator.wrap(function _callee2$(_context2) {
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
	            _context2.next = 2;
	            return miro.getClientId();
	          ...
	          case 8:
	            ...
	            maxWidth = Math.max.apply(Math, toConsumableArray(items.map(function (item) {
	              return item.rate;
	            }))) * 2;
	            items.forEach( /*#__PURE__*/function () {
	              var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(_ref, i) {
	                var role, rate, shapes, shape, width, x, _x3, y;

	                return regenerator.wrap(function _callee$(_context) {
	                  while (1) {
	                    switch (_context.prev = _context.next) {
	                      case 0:
	                        role = _ref.role, rate = _ref.rate;
	                      ...
	                      case 4:
	                        shapes = _context.sent.filter(function (shape) {
	                          return !!shape.metadata[appId];
	                        });
	                        shape = shapes.find(function (shape) {
	                          return shape.metadata[appId].role === role;
	                        });
	                        width = rate * 2;
	                        ...
	                        if (shape) {
	                          ...
	                          _x3 = viewport.x + viewport.width / 2 - (maxWidth - width) / 2;
	                          y = viewport.y + ROW_HEIGHT / 2 + (ROW_HEIGHT + ROW_MARGIN) * i;
